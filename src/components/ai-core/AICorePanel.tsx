      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="fixed inset-0 z-[190] bg-slate-900/10 backdrop-blur-md"
          />
          ...
          <motion.div
            ...
            className="fixed bottom-24 right-6 md:right-8 z-[200] w-[calc(100%-3rem)] md:w-[440px]"
          >
            <GlassCard className="!p-0 border-white/80 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)] overflow-hidden rounded-[3rem] bg-white/60">
              {/* Header */}
              ...
              <div className="p-8 space-y-10 max-h-[60vh] overflow-y-auto stealth-scrollbar">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-6 rounded-[2rem] bg-white/40 border border-white/80 text-sm font-bold text-slate-700 leading-relaxed italic shadow-inner">
                    "{state.intent || 'Monitoring system signals for optimization opportunities...'}"
                  </div>
                </div>

                {/* Telemetry Grid */}
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-5 rounded-[1.75rem] bg-slate-50/50 border border-slate-100 flex flex-col gap-3 group hover:bg-white transition-all">
              ...
              <div className="p-6 bg-slate-50/80 border-t border-slate-100 flex items-center justify-center gap-3">
                ...
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]">End-to-End Neural Encryption Active</p>
              </div>
            </GlassCard>
          </motion.div>
        </>
