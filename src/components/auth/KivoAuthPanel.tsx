...
function AuthButton({
  ...
  return (
    <button
      type="button"
      className={[
        'flex h-[64px] w-full items-center justify-center gap-3 rounded-[22px] px-4 sm:h-[80px] sm:rounded-[28px] sm:gap-4',
        'text-[18px] font-medium tracking-[-0.03em] whitespace-nowrap sm:text-[28px]',
        ...
        dark
          ...
          : 'border border-black/[0.03] bg-white/72 text-black shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]',
      ].join(' ')}
    >
...
export function KivoAuthPanel() {
  return (
    ...
    >
      ...
      <div className="pt-5 text-center text-[16px] font-normal tracking-[-0.02em] text-black/48 sm:pt-7 sm:text-[24px]">
