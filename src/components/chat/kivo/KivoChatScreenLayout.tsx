...
type Props = {
  ...
  attachments: MessageAttachment[]; keyboardOffset: number; attachmentTrayRef: RefObject<HTMLDivElement | null>; removeAttachment: (attachmentId: string) => void; notice: KivoChatNotice | null;
...
export function KivoChatScreenLayout(props: Props) {
  ...
  return (
    <div className="fixed inset-0 h-[100dvh] w-screen overflow-hidden overscroll-none bg-gradient-to-b from-[#f7f7f5] via-[#f5f5f3] to-[#f2f2f0] text-[#2f3640]">
      ...
      <div className="relative h-full overflow-hidden transition-[padding-left] duration-300 ease-out" style={{ paddingLeft: `${contentLeftOffset}px` }}>
        <div className="mx-auto flex h-full min-h-0 w-full max-w-[560px] flex-col overflow-hidden">
          ...
          <div className="[&>div]:!left-[var(--kivo-composer-left)] [&>div]:!right-3 [&>div]:!mx-0 [&>div]:!w-auto [&>div]:!max-w-none [&>div]:!translate-x-0 [&>div]:transition-[left,right] [&>div]:duration-300 [&>div]:ease-out" style={{ ['--kivo-composer-left' as string]: `${composerLeftOffset}px` } as CSSProperties}>
