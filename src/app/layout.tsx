...
export const metadata: Metadata = { title: PRODUCT_NAME, description: PRODUCT_DESCRIPTION, applicationName: PRODUCT_NAME, appleWebApp: { capable: true, title: PRODUCT_NAME, statusBarStyle: 'default' }, keywords: ['Kivo','AI','Assistant','Productivity','Agent'], icons: { icon: [{ url: '/favicon.svg', type: 'image/svg+xml' },{ url: '/icon.svg', type: 'image/svg+xml' }], shortcut: ['/favicon.svg'], apple: [{ url: '/apple-icon', sizes: '180x180', type: 'image/png' }] }, manifest: '/manifest.webmanifest', openGraph: { title: PRODUCT_NAME, description: PRODUCT_DESCRIPTION, siteName: PRODUCT_NAME, type: 'website', images: [{ url: '/icon.svg', type: 'image/svg+xml' }] }, twitter: { card: 'summary', title: PRODUCT_NAME, description: PRODUCT_DESCRIPTION, images: ['/icon.svg'] } };
