 ...
 * Redirects legacy /api/analyze calls to the unified Agent vNext pipeline via src/agent/agent.ts.
 */
...
export async function POST(req: Request) {
  try {
    ...
    console.log("[LEGACY_API] Routing to Agent vNext compatibility bridge...");
