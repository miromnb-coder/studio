...
export default function AlertsPage() {
  return (
    <main className="mx-auto min-h-screen w-full max-w-md bg-[#f8f9fc] px-6 py-10">
      <h1 className="text-3xl font-semibold text-slate-900">Auralis Alerts</h1>
      <p className="mt-3 text-slate-500">Open alerts from billing, subscriptions, and proactive signal detection.</p>
