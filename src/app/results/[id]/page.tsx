      ...
      <main className="max-w-5xl mx-auto px-6 space-y-16">
        <header className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="space-y-4 max-w-2xl">
              ...
              <h1 className="text-5xl md:text-7xl font-bold font-headline tracking-tighter leading-[0.9] text-white">{analysis.title || 'Audit Report'}</h1>
        ...
        <section className="space-y-8">
          <div className="flex items-center gap-3 pb-4 border-b border-white/5">
            ...
            <h2 className="text-xl font-bold font-headline uppercase tracking-widest text-[12px] text-white">Operator Intelligence ({(items || []).length})</h2>
          </div>
                ...
                <div className="p-8 md:p-10 flex flex-col md:flex-row justify-between gap-8">
                  <div className="space-y-6 max-w-xl">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-3xl font-bold font-headline tracking-tight text-white">{item.title}</h3>
                ...
                <div className="bg-white/[0.02] border-t border-white/5 p-8 md:p-10 space-y-6">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2 w-full sm:w-auto">
                      ...
                      >
                        <a href={`mailto:support@${item.title?.split(' ')[0].toLowerCase()}.com?subject=Account Optimization: ${item.title}&body=${encodeURIComponent(item.copyableMessage || '')}`} className="text-white">
                          Execute Protocol
                        </a>
                      </Button>
                    </div>
        ...
        <footer className="pt-24 border-t border-white/5 flex flex-col items-center text-center gap-8">
          <div className="space-y-2">
            <h3 className="text-3xl font-bold font-headline text-white">Audit complete.</h3>
          ...
          <Button asChild variant="outline" className="h-14 px-8 rounded-2xl font-bold uppercase tracking-widest text-[10px] border-white/10 hover:bg-white/5">
            <Link href="/dashboard" className="text-white">Return to Operator</Link>
          </Button>
        </footer>
      </main>
    </div>
