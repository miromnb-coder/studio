...
import { SystemModuleCard } from '@/components/systems/SystemModuleCard';
import type { SystemModule } from '@/components/systems/types';
  ...
  const dashboardModules: SystemModule[] = [
    {
      id: 'action-hub',
      title: 'Action Engine',
      description: 'Trigger autonomous reasoning protocols.',
      status: activeProtocol ? 'active' : 'idle',
      actions: [
        { label: 'Run Global Audit', variant: 'primary', onClick: () => triggerProtocol('Global Audit'), loading: activeProtocol === 'Global Audit' },
    ...
    },
    {
      id: 'system-status',
      title: 'Logic Core',
      description: 'Real-time health of the neural infrastructure.',
      status: 'active',
      metrics: [
        { label: 'Neural Memory', value: 'In Sync' },
        { label: 'Arbitrage', value: 'Idle' },
        { label: 'Sandbox', value: 'Locked' },
      ...
      <main className="max-w-7xl mx-auto px-8 space-y-16">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-12">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 border border-white/5">
                ...
                <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Operator Active</span>
              </div>
            </div>
            ...
            <p className="text-xl text-muted-foreground font-medium max-w-lg leading-relaxed">
              Your autonomous operational environment. Monitor signals and trigger protocols.
            </p>
          </div>
          ...
          <div className="premium-card bg-primary text-background min-w-[320px] p-10 flex flex-col items-center justify-center text-center shadow-[0_32px_80px_-16px_rgba(148,148,247,0.4)]">
            <p className="text-[10px] font-bold uppercase tracking-widest opacity-60 mb-2">Neural Efficiency Score</p>
