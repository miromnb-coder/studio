      ...
      <main className="flex-1">
        ...
        <section className="relative pt-32 pb-32 px-8 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center space-y-12">
            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-white/5 border border-white/10 text-[10px] font-bold uppercase tracking-widest text-primary animate-in fade-in slide-in-from-bottom-2 duration-700">
              <Zap className="w-3 h-3 animate-pulse" />
              Autonomous Inbox Operator
            </div>
            
            <h1 className="text-7xl md:text-9xl font-bold font-headline leading-[0.9] tracking-tighter animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
              Your inbox is full of <span className="text-primary glow-primary">hidden money.</span>
            </h1>
            
            <p className="text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
        ...
        <section className="px-8 py-32 max-w-7xl mx-auto grid md:grid-cols-2 gap-24 items-center">
          <div className="space-y-12">
            ...
            <h2 className="text-5xl md:text-7xl font-bold font-headline leading-[0.9] tracking-tight">The Proactive <br/>Advantage.</h2>
      ...
      <footer className="py-24 px-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="flex items-center gap-4">
            <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center text-background font-bold text-sm">
              O
            </div>
